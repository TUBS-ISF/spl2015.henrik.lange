...
/**
 * Datatyp to store all parameters for one dataset question: package
 * learning_program;
 * 
 * import java.io.Serializable; import java.util.ArrayList;
 * 
 * /** Datatyp to store all parameters for one dataset question: The question
 * which should be asked answer: The correct answer(s) points: opional, if the
 * programm need it
 * 
 * @author Henrik Lange
 * 
...
class Dataset implements Serializable {
	 ...
	 *            The Question
	 * @param answer
	 *            The answers is a Arraylist
	 * @param points
	 *            Points for correct answer
	 * @param wrongAnswer
	 *            Alternative wrong answers, need for multiply choice
	 * @param theme
	...
	public String toString() {
		return "Question: " + question + " Answer: " + answer + " Points: "
				+ getPoints() + " Wrong Answer: " + getWrongAnswers()
				+ " Theme: " + getTheme() + "\n";
	}
